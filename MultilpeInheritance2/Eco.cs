...
namespace MultilpeInheritance2
{
    public class Eco:Car,IBrand
    {
        ...
        public Eco(string fuelType,int seats,string color,int tankcapacity,int numberofKmDriven,string brand,string model,int engineNumber,int chasisNumber):base( fuelType,seats, color,tankcapacity,numberofKmDriven)
        {
            s_makingID++;
